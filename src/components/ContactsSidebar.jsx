    ...
    return (
        <div className="flex-1 flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto w-full py-2">
                <h4 className="text-[#00a884] text-sm font-medium uppercase px-6 py-4">Contacts on PingMe</h4>

                {filteredUsers.length === 0 ? (
                    <div className="text-center text-[var(--wa-gray)] py-10">No contacts found</div>
                ) : (
